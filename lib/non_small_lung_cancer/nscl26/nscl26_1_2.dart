...
class NsclMutation5FirstLineTherapy2 extends StatelessWidget {
  ...
  static List<Option> options = [
    Option(
        ...
        nextPage: Nscl27(),
        infoPage: info1),
    Option(text: 'brigatinib (preferred)', nextPage: Nscl27(), infoPage: info2),
    Option(text: 'lorlatinib (preferred)', nextPage: Nscl27(), infoPage: info3),
    Option(text: 'ceritinib', nextPage: Nscl27(), infoPage: info4),
    Option(text: 'crizotinib', nextPage: Nscl28(), infoPage: info5),
  ];
  @override
...
Widget info1 = InfoPage(pageName: "Alectinib", infoList: [
  InfoItem(
      head: "About",
      body:
...
Widget info2 = InfoPage(pageName: "Brigatinib", infoList: [
  InfoItem(
      head: "About",
      body:
...
Widget info4 = InfoPage(pageName: "Ceritinib", infoList: [
  InfoItem(
      head: "About",
      body:
...
Widget info5 = InfoPage(pageName: "Crizotinib", infoList: [
  InfoItem(
      head: "About",
      body:
