...
Widget info2 = InfoPage(pageName: "EGFR S768I, L861Q, and/or G719X mutation positive", infoList: [
  InfoItem(head: "EGFR S786I", body: " S768I mutations in exon 20 of the EGFR gene are rare and are typically seen in conjunction with sensitizing EGFR mutations. Because of this mutation's rarity and the variability of responses of treated cases, its exact prognostic and predictive role is not fully understood. In our experience, S768I mutations in isolation do not necessarily confer sensitivity to erlotinib, but in conjunction with sensitizing EGFR mutations, S768I mutations do not restrict efficacy."),
  InfoItem(head: "L861Q ", body: "Mutations in the epidermal growth factor receptor (EGFR) kinase domain such as EGFR-L858R and EGFR-G719S have been reported to activate the kinase and also sensitize a subset of patients with non-small cell lung cancer to EGFR kinase inhibitor treatment. Nevertheless, for other common point mutations such as EGFR-L861Q, it is unclear whether and to what extent they sensitize toward gefitinib and erlotinib. Thus far, there is no reliable cellular assay to compare in a ligand-independent manner intrinsic kinase activity and drug sensitivity of the unmutated (wild type) and mutated EGFR kinase domain."),
  InfoItem(head: "G719X ", body: " Asians who develop non-small cell lung cancer (NSCLC) have a chance of approximately 50% of harboring the epidermal growth factor receptor (EGFR) mutation. The G719X mutation in EGFR has 3 subtypes (i.e., G719A, G719C, or G719S), all of them being classified as uncommon EGFR mutations. The EGFR mutation G719X is most often associated with lung adenocarcinoma. Conversely, its occurrence in lung squamous cell carcinoma is rare. Its response to tyrosine kinase inhibitor (TKI) treatment remains unknown."),
], links: [
...
Widget info3 = InfoPage(pageName: "EGFR exon 20 insertion mutation positive", infoList: [
  InfoItem(head: "About", body: "EGFR Exon 20 Insertion is present in 0.35% of AACR GENIE cases, with lung adenocarcinoma, conventional glioblastoma multiforme, glioblastoma, infiltrating renal pelvis and ureter urothelial carcinoma, and endometrial endometrioid adenocarcinoma having the greatest prevalence"),
], links: [
...
Widget info4 = InfoPage(pageName: "KRAS G12C mutation positive", infoList: [
  InfoItem(head: "About", body: "KRAS G12C is present in 2.45% of AACR GENIE cases, with lung adenocarcinoma, colon adenocarcinoma, non-small cell lung carcinoma, colorectal adenocarcinoma, and rectal adenocarcinoma having the greatest prevalence"),
], links: [
