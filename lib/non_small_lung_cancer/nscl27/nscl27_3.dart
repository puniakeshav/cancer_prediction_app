...
class Nscl27SubsequentTherapy3 extends StatelessWidget {
  ...
  static List<UnselectableOption> options = [
    ...
    UnselectableOption(
        ...
        infoPage: info2),
    UnselectableOption(text: 'Lorlatinib (ALK G1202R)', infoPage: info3),
    UnselectableOption(
        text: 'or Therapy for multiple lesions', infoPage: info4),
...
Widget info4 =
    InfoPage(pageName: "Therapy for multiple lesions", infoList: [], links: []);
