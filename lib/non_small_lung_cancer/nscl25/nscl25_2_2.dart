...
class Nscl25_2_2 extends StatelessWidget {
  ...
  static List<UnselectableOption> options = [
    ...
    UnselectableOption(text: 'Maintenance Therapy', infoPage: info2),
    UnselectableOption(text: 'Pallative care', infoPage: info3),
  ];
...
Widget info2 = InfoPage(pageName: "Maintenance Therapy", infoList: [], links: []);

Widget info3 = InfoPage(pageName: "Pallative care", infoList: [], links: []);