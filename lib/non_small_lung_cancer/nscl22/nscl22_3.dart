...
Widget info2 = InfoPage(pageName: "erlotinib (± ramucirumab or bevacizumabrr) or afatinib or gefitinib or dacomitinib", infoList: [
  ...
  Widget info3 = InfoPage(pageName: "Therapy for multiple lesions", infoList: [], links: []);
